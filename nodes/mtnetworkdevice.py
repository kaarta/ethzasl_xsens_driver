...
class MTNetworkDevice(object):
    ...
    def ChangeBaudrate(self, baudrate):
        ...
        #Disabled for now because we don't want to ever change the baud rate. 
        # The STM32 expects 230400 and will be unable to communicate if this is changed.        
        return
...
Usage:
    ./mtnetworkdevice.py [commands] [opts]
...
Synchronization settings:
    ...
    Examples:
        ...
        ./mtnetworkdevice.py -y 3,2,1,0,0,0,0,0 -y 9,0,1,0,0,0,10,0

        To clear the synchronization settings of MTi
        ./mtnetworkdevice.py -y clear
...
UTC time settings:
    ...
    Examples:
        ...
        ./mtnetworkdevice.py -u now
        ./mtnetworkdevice.py -u 1999,1,1,0,0,0,0,0
...
Option flags:
    ...
    Examples:
        Only set DisableAutoStore and DisableAutoMeasurement flags:
            ./mtnetworkdevice.py -o 0x03,0x00
        Disable AHS (clear EnableAHS flag):
            ./mtnetworkdevice.py -o 0x00,0x10
        Set DisableAutoStore and clear DisableAutoMeasurement:
            ./mtnetworkdevice.py -o 0x02,0x01
